# STATUS ARCHIVE — bluegreen-marketplace

Sessions up to and including 2026-08-29, moved verbatim out of `STATUS.md` on 2026-08-30.

Kept for the decisions and the measurements it carries — notably the plugin split (`#66`) and the
`/edifice front` investigation (`#60`) — none of which are derivable from the code or from git
history. Original language preserved (French). Not loaded at session start.

Read it as a record, not as a to-do list: several of its open-looking items (`#60`, `#66`, `#50`,
`#44`, `#27`) were closed after it was written.

For the live status, see [`STATUS.md`](./STATUS.md).
